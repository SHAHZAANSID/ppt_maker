...
# =====API VALIDATIONS=====
if not all(ALL_API):
  st.sidebar.error("API_KEYS LOADED SUCCESFULLY")
  # model load
...
def search_latest_info(query):
  """this function helps to give latest searchusing tavily
...
user_input = st.text_area("wite here: ")
...
if (user_input) and (leader_agent):
  # tab1 code
  with tab1:
    if st.button("Generate Imag", key = "Gen-Image"):
